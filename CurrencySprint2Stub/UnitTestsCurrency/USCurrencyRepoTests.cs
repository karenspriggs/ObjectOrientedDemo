...
namespace UnitTestsCurrency
{
    ...
    public class USCurrencyRepoTests
    {
        ...
        public void MakeChangeTests()
        {
            ...
            //Act
            changeTwoDollars = (USCurrencyRepo)USCurrencyRepo.CreateChange(2.0m);
            changeOneDollarOneHalfDoller = (USCurrencyRepo)USCurrencyRepo.CreateChange(1.5m);
            changeOneQuatersOnHalfDollar = (USCurrencyRepo)USCurrencyRepo.CreateChange(.75m);

            changeOneDimeOnePenny = (USCurrencyRepo)USCurrencyRepo.CreateChange(.11m);
            changeOneNickelOnePenny = (USCurrencyRepo)USCurrencyRepo.CreateChange(.06m);
            changeFourPennies = (USCurrencyRepo)USCurrencyRepo.CreateChange(.04m);
            ...
            Assert.AreEqual(4, changeFourPennies.Coins.Count);
