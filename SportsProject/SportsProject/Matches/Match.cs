...
namespace SportsProject.Matches
{
    public class Match : IMatch
    {
        ...
        public void SetTime()
        {
            MatchTime = DateTime.Now.Date;
        }

        public void DetermineWinner(int score1, int score2)
        {
            if (score1 > score2)
            {
                team1.TeamWins();
                team1.UpdateRating();
                results = $"{team1.Name} won!";
            }
            else
            {
                if (score1 < score2)
                ...
                else
                {
                    ...
                    team2.TeamWins();
                    team2.UpdateRating();
                    results = $"{team1.Name} and {team2.Name} had a draw!";
                }
            }
        }
    }
